...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("сто шестьдесят три тысячи двести тридцать", russian(163230))
        assertEquals("триста тридцать тысяч восемьсот восемьдесят три", russian(330883))
    }
}